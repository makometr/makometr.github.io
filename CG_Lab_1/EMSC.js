...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/EMSC.data';
      var REMOTE_PACKAGE_BASE = 'EMSC.data';
...
Module['FS_createPath']('/resources', 'shaders', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_bin/EMSC.data');

      };
      Module['addRunDependency']('datafile_bin/EMSC.data');
   ...
   loadPackage({"files": [{"filename": "/resources/shaders/basic.fs", "start": 0, "end": 116, "audio": 0}, {"filename": "/resources/shaders/basic.vs", "start": 116, "end": 325, "audio": 0}], "remote_package_size": 325, "package_uuid": "40ba5dac-7a68-49e1-8ec9-a79b7faadb1e"});
...
function screen_get_avail_size(w,h){ HEAP32[w >> 2] = window.screen.availWidth; HEAP32[h >> 2] = window.screen.availHeight; }
function window_get_inner_size(w,h){ console.log(w); HEAP32[w >> 2] = window.innerWidth; HEAP32[h >> 2] = window.innerHeight; }
